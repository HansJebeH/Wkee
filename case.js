...
ppuser = 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png?q=60'
 ...
 "itemCount":999999999,
 "status":"INQUIRY","surface":"CATALOG","message":`Created By rizal`,
...
image: Kyuuu, 
  ...
  thumbnail: cewegw,
  mediaType: 4,
  MediaUrl:'https://www.youtube.com/@zal_x_u',
  sourceUrl:"https://www.youtube.com/@zal_x_u",
  }}
  }
...
break
case 'qc': {
if (!q) return reply(`❄️ *Contoh : Qc White rizal*\n🎁 *Kode Warna Ketik : Qckode*`)
if (text.length > 100) return reply(`❄️ *Maksimal 100 Karakter*`)
...
break;
default:
return reply('❄️ *Kode Warna Tidak Ditemukan*\n🎁 *Contoh : Qc White Rizal*\n⚠️ *Tolong Gunakan Huruf Kecil Pada Kode Warna ketik .qckode untuk menampilkan warna*')
}
let obj = {
type: 'quote',
format: 'png',
...
name: pushname,
photo: { 
url: await putu.profilePictureUrl(m.sender, "image").catch(() => 'https://telegra.ph/file/6880771a42bad09dd6087.jpg'),
}
},
text: message,
replyMessage: {},
...
putu.sendImageAsSticker(m.chat, buffer, m, { packname: `${global.packname}`, author: `${global.author}`})
}
break
case 'qckode': {
reply(`❄️ *Kode Warna Qc*
⨠ *Pink*
⨠ *Blue*
⨠ *Red*
⨠ *Green*
...
▢ *Kalo Ada Error Bisa Chat Owner Ya* ❄️
`)
}
break
//=================================================//
